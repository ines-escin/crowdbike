...
@Service("OcorrenciaServiceRestBO")
@Transactional(propagation=Propagation.REQUIRED)
public class OcorrenciaServiceRestBOImp implements OcorrenciaServiceRestBO{
	...
	public MsgResponse getAlertByLatLng(double lat, double lng, double dist) {
		// TODO Auto-generated method stub
		return ocorrenciaDAO.getAlertByLatLng(lat, lng, dist);
	}
